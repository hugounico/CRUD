...
class DirectorGeneral(models.Model):
    ...
    laboratorio = models.CharField(Lmax_length=100) #on_delete=models.CASCADE#models.OneToOneField es una clase de campo proporcionada por Django. Indica que se va a establecer una relación uno a uno entre dos modelos.
